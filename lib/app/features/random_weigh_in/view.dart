...
class RandomWeighInView extends StatelessWidget {
  const RandomWeighInView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(RandomWeighInController());
      ...
      body: RefreshIndicator(
        ...
        child: Obx(() {
          ...
          if (controller.events.isEmpty) {
            return Center(child: Text('No random weigh ins available'));
          }
  ...
  Widget _buildDateSection(
    ...
    DateTime date,
    List<RandomWeighIn> events,
    RandomWeighInController controller, {
